...
public class diziler {
    public static void main(String[] args) {
        ...
        String[] adlar = {"ali","ayşe","cihan","betül"};
        System.out.println(adlar.length);
        System.out.println(adlar[0]);
        System.out.println(adlar[adlar.length-adlar.length]);
        System.out.println(adlar[3].charAt(3)); // betül'ün 3. harfi olan ü'yü getirir
