...
public class methodlarda_override {
    public static void main(String[] args) {
        Kare k = new Kare();
        System.out.println(k.alanHesapla(5));
        //üstte çokgenden miras alınan alanHesapla() methodu geçersiz olur
        //kendi içindeki alanHesapla() methodu çalışır
        //bu geçersiz olma işlemine methodlarda override denir.
    }
}
